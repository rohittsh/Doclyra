    ...
    <div className='m-5 w-full'>
      ...
      <div className='grid gap-3 md:grid-cols-4 mt-6'>
        <div className='bg-white rounded-xl border p-4'>
          ...
          <p className='text-2xl font-semibold text-gray-800 mt-1'>{dashData.completedAppointments || 0}</p>
        </div>
        <div className='bg-white rounded-xl border p-4'>
          <p className='text-sm text-gray-500'>Pending visits</p>
          <p className='text-2xl font-semibold text-gray-800 mt-1'>{dashData.pendingAppointments || 0}</p>
        </div>
        <div className='bg-white rounded-xl border p-4'>
          <p className='text-sm text-gray-500'>Cancelled visits</p>
          <p className='text-2xl font-semibold text-gray-800 mt-1'>{dashData.cancelledAppointments || 0}</p>
        </div>
        <div className='bg-white rounded-xl border p-4'>
          <p className='text-sm text-gray-500'>Revenue collected</p>
          <p className='text-2xl font-semibold text-gray-800 mt-1'>₹{dashData.revenue || 0}</p>
        </div>
      </div>
